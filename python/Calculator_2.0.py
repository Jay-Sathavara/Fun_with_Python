...
clear = Button(frame, text='Clear', height=2, width=6, font=35, command=_clear)
...
equal = Button(window, text='=', height=2, width=27, font=35, command=equals)
equal.pack()
